...
export const getKakaoToken = (kakaoCode) => async (dispatch, getState) => {
    const URL_HOST = "https://kauth.kakao.com/oauth/token?grant_type=authorization_code&client_id=dab58a800514cc429576cf0f84c83ab0&redirect_uri=https://vawtnz7go1.execute-api.ap-northeast-2.amazonaws.com/oauth&code=";
    try {
